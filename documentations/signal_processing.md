...
|     P16    |                  $P_{16} = \frac{\sum_{k=1}^{K} f_k \cdot s(k)}{\sum_{k=1}^{K} s(k)}$                  |             FS Spectral Centroid             |        ```damavand.damavand.signal_processing.feature_extraction.P17```       |             |
|     P17    |                 $P_{17} = \sqrt{\frac{\sum_{k=1}^{K} (f_k - P_{16})^2 \cdot s(k)}{K}}$                 |                                              |        ```damavand.damavand.signal_processing.feature_extraction.P18```       |             |
|     P18    |              $P_{18} = \sqrt{\frac{\sum_{k=1}^{K} f_k^2 \cdot s(k)}{\sum_{k=1}^{K} s(k)}}$             |                                              |        ```damavand.damavand.signal_processing.feature_extraction.P19```       |             |
|     P19    |        $P_{19} = \sqrt{\frac{\sum_{k=1}^{K} f_k^4 \cdot s(k)}{\sum_{k=1}^{K} f_k^2 \cdot s(k)}}$       |                                              |        ```damavand.damavand.signal_processing.feature_extraction.P20```       |             |
|     P20    | $P_{20} = \frac{\sum_{k=1}^{K} f_k^2 \cdot s(k)}{\sum_{k=1}^{K} s(k) \sum_{k=1}^{K} f_k^4 \cdot s(k)}$ |                                              |        ```damavand.damavand.signal_processing.feature_extraction.P21```       |             |
|     P21    |                                    $P_{21} = \frac{P_{17}}{P_{16}}$                                    |                                              |        ```damavand.damavand.signal_processing.feature_extraction.P22```       |             |
